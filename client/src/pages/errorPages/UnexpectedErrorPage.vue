<template>
  <div class='flex h-[calc(100vh)] items-center justify-center p-5 w-full bg-gray-100'>
    <div class='text-center'>
      ...
      <p class='text-slate-600 mt-5 lg:text-lg'>Oops something went wrong... <br> Try again or feel free to contact us
        if the problem persists.</p>

      <router-link :to="{name: 'Home'}">
        <button
          class='mt-5 px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-800 focus:outline-none focus:shadow-outline-red active:bg-red-800'>
          Home Page
        </button>
      </router-link>
